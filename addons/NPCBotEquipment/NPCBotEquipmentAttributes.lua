...
local function CreateAttributesPanel(frame)
    ...
    local left = createInset(panel, "TOPLEFT", specInset, "BOTTOMLEFT", 0, -6, 176, 290)
    local right = createInset(panel, "TOPRIGHT", specInset, "BOTTOMRIGHT", 0, -6, 176, 290)
    local leftTitle = left:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    leftTitle:SetPoint("TOP", left, "TOP", 0, -8)
    ...
    rightTitle:SetPoint("TOP", right, "TOP", 0, -8)
