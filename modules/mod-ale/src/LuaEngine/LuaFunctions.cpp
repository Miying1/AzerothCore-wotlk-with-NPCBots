...
ALERegister<Player> PlayerMethods[] =
{
    ...
    { "GetNPCBotEquipmentSnapshot", &LuaPlayer::GetNPCBotEquipmentSnapshot },
    { "GetNPCBotAttributes", &LuaPlayer::GetNPCBotAttributes },
    { "GetNPCBotManagement", &LuaPlayer::GetNPCBotManagement },
    { "GetNPCBotEquipCandidates", &LuaPlayer::GetNPCBotEquipCandidates },
