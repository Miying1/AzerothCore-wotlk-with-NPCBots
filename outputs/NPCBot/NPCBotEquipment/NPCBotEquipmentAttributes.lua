...
local function CreateAttributesPanel(frame)
    ...
    local specInset = createInset(panel, "TOPLEFT", panel, "TOPLEFT", 0, 0, 748, 58)
    ...
    local left = createInset(panel, "TOPLEFT", specInset, "BOTTOMLEFT", 0, -12, 364, 352)
    local right = createInset(panel, "TOPRIGHT", specInset, "BOTTOMRIGHT", 0, -12, 364, 352)
