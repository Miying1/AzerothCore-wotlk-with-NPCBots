...
SET @RIFT_BOSS_ENTRY_BASE := 100100;
...
(@RIFT_BOSS_ID_BASE + 62,18708,@RIFT_BOSS_ENTRY_BASE + 186,1,'boss_rift_murmur','暗影迷宫',555,-157.895,-497.322,15.8651,1.5625,-156.64,-392.15,17.08,4.72,'摩摩尔；玩家传入点来自整合表格'),
(@RIFT_BOSS_ID_BASE + 62,18708,@RIFT_BOSS_ENTRY_BASE + 187,2,'boss_rift_murmur','暗影迷宫',555,-157.895,-497.322,15.8651,1.5625,-156.64,-392.15,17.08,4.72,'摩摩尔；玩家传入点来自整合表格'),
(@RIFT_BOSS_ID_BASE + 62,18708,@RIFT_BOSS_ENTRY_BASE + 188,3,'boss_rift_murmur','暗影迷宫',555,-157.895,-497.322,15.8651,1.5625,-156.64,-392.15,17.08,4.72,'摩摩尔；玩家传入点来自整合表格'),
