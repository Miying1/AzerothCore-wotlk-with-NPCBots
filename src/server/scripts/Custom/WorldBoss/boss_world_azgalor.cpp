 ...
 *  - 末日诅咒的目标筛选（排除主目标）与死亡触发（末日降临 31348）复用原版法术脚本
 *    （spell_azgalor_doom / spell_azgalor_doom_aura，已注册在 31347 上，不依赖副本环境）；
...
enum AzgalorSpells
{
    ...
    SPELL_DOOM            = 31347, // 末日诅咒（AOE 诅咒，排除主目标，周期触发末日降临）
