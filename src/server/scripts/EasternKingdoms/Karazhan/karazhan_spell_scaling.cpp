...
{
    // ---- 直接法术伤害（direct） ----
    { 30383, { 4.5f, 0.0f } }, // 馆长·憎恨之箭 4434-5999 -> 13300-18000
    ...
    { 29949, { 9.5f, 0.0f } }, // 埃兰·花环爆炸(穿圈惩罚) 3237-3762 -> 27500-32000
    { 29956, { 3.8f, 0.0f } }, // 埃兰·奥术飞弹(每发, 子法术) 1260-1540 -> 4000-4900
    { 30055, { 3.6f, 0.0f } }, // 泰雷斯蒂安·暗影箭 3187-4312 -> 11470-15520
    { 30852, { 5.5f, 0.0f } }, // 玛克扎尔·暗影新星(AOE) 3000 -> 14100
    { 32337, { 4.5f, 0.0f } }, // 老巫婆·闪电链 2774-3225 -> 10260-11930
    { 30282, { 3.5f, 0.0f } }, // 夜之魇·火球齐射 2549-3450 -> 8920-12080
    { 29904, { 3.4f, 0.0f } }, // 沙迪基斯·音爆 2187-2812 -> 7440-9560
    { 31012, { 3.5f, 0.0f } }, // 桃乐丝·水箭(高频) 2024-2475 -> 5870-7180
    ...
    { 30050, { 10.0f, 0.0f } }, // 小鬼·火球 180-209 -> 1440-1670
    ...
    { 29964, { 0.0f, 3.8f } }, // 埃兰·龙息术 2000/2s -> 6000/2s
    { 29522, { 3.4f, 3.8f } }, // 贞洁圣女·神圣之火(直伤+DOT) 直3238-3762 + DOT1750/2s
    { 30210, { 3.9f, 3.5f } }, // 夜之魇·灼热吐息(直伤+DOT) 直3699-4300 + DOT1687-1912/3s
    { 30854, { 0.0f, 4.5f } }, // 玛克扎尔·暗言术:痛 1500/3s -> 4500/3s
    ...
    { 29951, { 0.0f, 3.5f } }, // 暴风雪 DOT 1313-1687/2s -> 3939-5061/2s
    ...
    // ---- 馆长召唤物·星界火花（Astral Flare, 17096） ----
    { 30235, { 3.4f, 0.0f } }, // 星界火花·弧光凋零(奥术) 674-825/1s -> 2022-2475/1s
};
