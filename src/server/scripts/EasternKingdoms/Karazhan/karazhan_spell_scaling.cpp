...
{
    // ---- 直接法术伤害（direct） ----
    // 备注口径：DBC 实际值先由 CalcValue 计算，再按脚本 float 倍率截断为 int32。
    // 带 SPELL_ATTR0_SCALES_WITH_CREATURE_LEVEL 的法术还会先按施法者/70 级 exp=2 基础伤害比缩放。
    { 30383, { 4.0f, 0.0f } }, // 馆长·憎恨之箭 4435-5999 -> 19957-26995
    { 29973, { 3.5f, 0.0f } }, // 埃兰·奥术爆炸 9000-11000 -> 31500-38500
    { 29978, { 4.5f, 0.0f } }, // 埃兰83级/影子18254为82级：6800 -> 9727/9505 -> 43771/42772
    { 29953, { 2.8f, 0.0f } }, // 埃兰·火球术 3910-5290 -> 10948-14812
    { 29954, { 2.9f, 0.0f } }, // 埃兰·寒冰箭 3500-4500 -> 10150-13050
    { 29949, { 9.5f, 0.0f } }, // 埃兰·花环爆炸(穿圈惩罚) 3238-3762 -> 30761-35739
    { 29956, { 2.8f, 0.0f } }, // 埃兰·奥术飞弹(每发, 子法术) 1260-1540 -> 等级缩放1802-2203 -> 6847-8371
    { 30055, { 3.6f, 0.0f } }, // 泰雷斯蒂安·暗影箭 3188-4312 -> 11476-15523
    { 30852, { 5.5f, 0.0f } }, // 玛克扎尔·暗影新星(AOE) 3000 -> 16500
    { 32337, { 4.5f, 0.0f } }, // 老巫婆·闪电链 2775-3225 -> 12487-14512
    { 30282, { 3.2f, 0.0f } }, // 夜之魇·火球齐射 2550-3450 -> 等级缩放3647-4935 -> 12764-17272
    { 29904, { 3.4f, 0.0f } }, // 沙迪基斯·音爆 2188-2812 -> 7439-9560
    { 31012, { 3.5f, 0.0f } }, // 桃乐丝·水箭(高频) 2025-2475 -> 7087-8662
    { 32445, { 5.5f, 0.0f } }, // 贞洁圣女·神圣之怒(80码AOE) 1950-2050 -> 10725-11275
    { 30815, { 4.5f, 0.0f } }, // 罗密欧·后跳突刺 1900-2100 -> 8550-9450
    { 30128, { 4.0f, 0.0f } }, // 夜之魇·烟爆 1850-2150 -> 7400-8600
    { 37057, { 4.0f, 0.0f } }, // 夜之魇·烟爆(空战T变体) 1850-2150 -> 7400-8600
    { 29711, { 3.0f, 0.0f } }, // 午夜·击倒(控制+小伤) 1500 -> 4500
    { 29425, { 3.0f, 0.0f } }, // 莫罗斯·凿击(控制+小伤) 950-1050 -> 2850-3150
    { 30050, { 10.0f, 0.0f } }, // 小鬼·火球 181-209 -> 1810-2090
    { 38524, { 3.0f, 0.0f } }, // 虚空幽龙·虚空吐息(子法术) 4163-4837 -> 12489-14511
    { 30860, { 4.0f, 0.0f } }, // 地狱火·灼烧(每跳, 子法术) 875-1125 -> 3500-4500

    // ---- DOT 周期伤害（periodic，每跳） ----
    { 30129, { 0.0f, 2.8f } }, // 夜之魇·焦土 2188-2812/3s -> 6126-7873/3s
    { 29964, { 0.0f, 3.8f } }, // 埃兰·龙息术 2000/2s -> 7600/2s
    { 29522, { 3.4f, 3.8f } }, // 贞洁圣女·神圣之火 直3238-3762 -> 11009-12790；DOT1750/2s -> 6650/2s
    { 30210, { 3.9f, 3.5f } }, // 夜之魇·灼热吐息 直3700-4300 -> 14430-16770；DOT1688-1912/3s -> 5908-6692/3s
    { 30854, { 0.0f, 4.5f } }, // 玛克扎尔·暗言术:痛 1500/3s -> 6750/3s
    { 37066, { 0.0f, 3.0f } }, // 莫罗斯·绞喉 1075/3s -> 3225/3s
    { 30890, { 4.0f, 3.3f } }, // 朱丽叶·盲目激情 直1500 -> 6000；DOT750/1s -> 2475/1s
    { 29906, { 0.0f, 4.0f } }, // 罗卡德·蹂躏(DOT段) 510-690/2s -> 2040-2760/2s
    { 31041, { 3.2f, 4.0f } }, // 狮吼·撕裂 直1600-2400 -> 5120-7680；DOT500/3s -> 2000/3s
    ...
    { 29951, { 0.0f, 3.5f } }, // 暴风雪 DOT 1313-1687/2s -> 4595-5904/2s

    // ---- 莫罗斯宾客（6选4，精英级召唤物，统一 2.0×） ----
    { 29563, { 2.0f, 2.0f } }, // 宾客·神圣之火 直837-1063 -> 1674-2126；DOT950/2s -> 1900/2s
    { 24212, { 0.0f, 2.0f } }, // 宾客·暗言术痛 DOT 704-796/3s -> 1408-1592/3s
    { 29570, { 0.0f, 2.0f } }, // 宾客·精神鞭笞 DOT 875/1s -> 1750/1s
    { 29386, { 2.0f, 0.0f } }, // 宾客·命令审判 直1425-1575 -> 2850-3150

    // ---- 馆长召唤物·星界光芒（Astral Flare, 17096/19781/19782/19783） ----
    { 30235, { 3.4f, 0.0f } }, // 星界光芒·弧光凋零(奥术) 675-825 -> 2295-2805
};
