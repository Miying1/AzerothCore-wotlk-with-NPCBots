...
constexpr uint32 EntranceRefillIntervalTier1Milliseconds = 2 * MINUTE * IN_MILLISECONDS;
constexpr uint32 EntranceRefillIntervalTier2Milliseconds = 4 * MINUTE * IN_MILLISECONDS;
